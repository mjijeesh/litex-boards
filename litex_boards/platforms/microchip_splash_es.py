...
class Platform(MicrosemiPlatform):
    ...
    def __init__(self, toolchain="libero_soc"):
        MicrosemiPlatform.__init__(self, "MPF300T_ES-1FCG484I", _io, toolchain=toolchain)
    ...
    def do_finalize(self, fragment):
        ...
        # 3. Append your Libero I/O bank constraints (escaped as proper Python multi-line strings)
        io_bank_constraints = [
            "set_iobank -bank_name Bank0 -vcci 1.20 -vref 0.60 -fixed true",
            "set_iobank -bank_name Bank1 -vcci 1.20 -vref 0.60 -fixed true",
            "set_iobank -bank_name Bank2 -vcci 3.30 -fixed true",
            "set_iobank -bank_name Bank4 -vcci 3.30 -fixed true",
            "set_iobank -bank_name Bank5 -vcci 3.30 -fixed true"
        ]
        
        # Add them to the global command collection for Libero execution
        self.toolchain.additional_iobank_constraints.extend(io_bank_constraints)
